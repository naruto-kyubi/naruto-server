...
public class UserError extends CommonError {
    ...
    public static CommonError USER_NOT_EXIST_ERROR = new UserError("user.not.exist.error","User not exist");
    public static CommonError NICKNAME_EXIST_ERROR = new UserError("nickname.exist.error","Nickname aleady in use");
