...
@Component
@Slf4j
public class JwtAuthOrRememberFilter extends AuthenticatingFilter {
    ...
    protected void postHandle(ServletRequest request, ServletResponse response){
        ...
        request.setAttribute("JwtAuthOrRememberFilter.FILTERED", true);
    }
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) {
        ...
        if(this.isLoginRequest(request, response))
            return true;
        Boolean afterFiltered = (Boolean)(request.getAttribute("JwtAuthOrRememberFilter.FILTERED"));
        ...
        if(!allowed){
            ...
            if(null!=subject.getPrincipal()) allowed = true;
        }
